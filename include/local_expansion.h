...
public:
	    ...
	    static gsl_matrix * A_n_m_Matrix(unsigned int dimension)
	    	{
	    	gsl_matrix* A_n_m = gsl_matrix_calloc(dimension+1,dimension+1);
	    ...
	    mExp_to_lExp_Coeff_Build(gsl_matrix * A_n_m, unsigned int p)
	    	{
